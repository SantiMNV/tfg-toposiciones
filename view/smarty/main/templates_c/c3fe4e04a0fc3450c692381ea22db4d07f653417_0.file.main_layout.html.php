<?php
/* Smarty version 3.1.39, created on 2021-04-21 13:25:20
  from 'C:\xampp\htdocs\toposiciones\view\smarty\main\templates\layouts\main_layout.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array(
  'version' => '3.1.39',
  'unifunc' => 'content_60800ba0c471a8_57172277',
  'has_nocache_code' => false,
  'file_dependency' =>
  array(
    'c3fe4e04a0fc3450c692381ea22db4d07f653417' =>
    array(
      0 => 'C:\\xampp\\htdocs\\toposiciones\\view\\smarty\\main\\templates\\layouts\\main_layout.html',
      1 => 1619004318,
      2 => 'file',
    ),
  ),
  ...
  function content_60800ba0c471a8_57172277(Smarty_Internal_Template $_smarty_tpl) {
...
/images/company/fototopo64v2.png">
        ...
        <div class="collapse col-md-9 navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav col-md-8 col-sm-6 col-6" id="main-menu">
            <li class="nav-item">
              <a class="nav-link <?php if ($_smarty_tpl->tpl_vars['page']->value->getCurrentPage() == 'Convocatorias') { ?>active-link<?php } ?>" href="/toposiciones/convocatorias/">
        ...
        <li class="nav-item"><a class="nav-link <?php if ($_smarty_tpl->tpl_vars['page']->value->getCurrentPage() == 'Soluciones') { ?>active-link<?php } ?>"
            ...
            <li class="nav-item"><a class="nav-link <?php if ($_smarty_tpl->tpl_vars['page']->value->getCurrentPage() == 'Foro') { ?>active-link<?php } ?>" href="/toposiciones/foro/">
                <!-- <i class="fas fa-comments"></i> -->
                Foro
              </a></li>
            <li class="nav-item"><a class="nav-link <?php if ($_smarty_tpl->tpl_vars['page']->value->getCurrentPage() == 'Contacto') { ?>active-link<?php } ?>" href="/toposiciones/contacto/">
 ...
 alert-dismissable">
                ...
                <div class="modal-body">
                  <div class="notice d-flex justify-content-between align-items-center">
                    ...
                    <div class="buttons d-flex flex-column flex-lg-row">
                      ...
                      <a href="/toposiciones/privacidad/" class="btn btn-light btn-sm" data-dismiss="modal">
                        Leer más.
                      </a>
                    </div>
                  </div>
      ...
      -->
          ...
          <div class="body-content">
            <?php
            $_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_161793635360800ba0c42058_77061572', "body-content");
            ?>
...
/images/profile_pic.jpeg" alt="Messi">
      ...
      <footer class="text-center">
        <div class="p-4">
          <section class="mb-4">
            <!-- Google -->
            <a class="btn btn-outline-light m-2" href="mailto:santimnv27@gmail.com" role="button"><i class="fab fa-google"></i></a>
            <!-- Linkedin -->
            <a class="btn btn-outline-light m-2" href="www.linkedin.com/in/santimnv" role="button"><i class="fab fa-linkedin-in"></i></a>
            <!-- Github -->
            <a class="btn btn-outline-light m-2" href="https://github.com/santimnv" role="button"><i class="fab fa-github"></i></a>
          </section>
          <section class="mb-4">
            <p>
    ...
    >
          ...
          /* {block "body-content"} */
          class Block_161793635360800ba0c42058_77061572 extends Smarty_Internal_Block {
            public $subBlocks = array(
              'body-content' =>
              array(
                0 => 'Block_161793635360800ba0c42058_77061572',
              ),
            );
